   ...
   */
   public void printArray( )
   {
    ...
    // Write your code here:
	   ...
	   for (int row = 0; row < intArray.length; row++) { //for loop for row

	   for (int column = 0; column < intArray[row].length; column++) { //for loop for column

	   System.out.print(" " + intArray[row][column]); //array

	   animate(row, column); // animate
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    // Write your code here:
	   ...
	   System.out.println("........Set Value...... for row " + row + " with value= " + value); //set values

	   for (int i = 0; i < intArray.length; i++) { //for loop for length

		   if (i == row) { 

			   for (int j = 0; j < intArray[i].length; j++) { //for loop inner loop

				   intArray[i][j] = value; //set position = value
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   ...
	   System.out.println("... Find Minimum from Column =" + column); //find min

	   int min = Integer.MAX_VALUE;// cream default min val

	   for (int i = 0; i < intArray.length; i++) { //for loop to iterate through array

		   if (min > intArray[i][column]) {
	
			   min = intArray[i][column];// set min = to new val
	
		   }

		   animate(i, column, min); // animate output

	   }

	   System.out.println("Minimum of in column " + column + " = " + min); //print new min
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	   ...
	   System.out.println(".....Count Frequency of value= " + value + " in the matrix."); //find count

	   int count = 0; // create var for count

	   for (int row = 0; row < intArray.length; row++) { //for loop to iterate through row

		   for (int column = 0; column < intArray[row].length; column++) { //for loop to iterate through col
	
			   if (intArray[row][column] == value) {  //if current val = val
	
				   	count = count + 1; // increase count by 1
	
		   }

		    animate(row, column, count); //animate output

		   }

	   }

	   System.out.println("Number of times value = " + value + " occured is = " + count); //print count
